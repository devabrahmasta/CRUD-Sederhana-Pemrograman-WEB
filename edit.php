...
<body>
    <nav class="navbar navbar-expand-lg bg-success">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white fw-bold" aria-current="page" href="index.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active text-white-50 fw-bold" href="tambah.php">Tambah Film</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="card mb-3" style="width: 40rem;">
            <div class="card-body">
                <h2 class="card-title text-center fw-bold">EDIT FILM</h2>
                <form action="update.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="sutradara" value="<?php echo $row['sutradara'] ?>" required>
                    </div>
                    <div class="mb-3">
